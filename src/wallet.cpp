...
// troutcoin: total coins staked (non-spendable until maturity)
...
// troutcoin: check 'spent' consistency between wallet and txindex
// troutcoin: fix wallet spent state according to txindex
...
// troutcoin: disable transaction (only for coinstake)

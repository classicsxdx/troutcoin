...
public:
    ...
    {
        // troutcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // troutcoin: get transaction coin age
...
public:
    ...
    // troutcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // troutcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // troutcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // troutcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // troutcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // troutcoin: block index flags
    enum  
    {

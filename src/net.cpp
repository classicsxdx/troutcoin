...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "troutcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"seed1.troutcoin.eu", "seed1.troutcoin.eu"},
    {"seed2.troutcoin.eu", "seed2.troutcoin.eu"},
    {"seed3.troutcoin.eu", "seed3.troutcoin.eu"},
    {"seed4.troutcoin.eu", "seed4.troutcoin.eu"},
    {"seed5.troutcoin.eu", "seed5.troutcoin.eu"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("troutcoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("troutcoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("troutcoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("troutcoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. troutcoin is probably already running."), addrBind.ToString().c_str());
        else
